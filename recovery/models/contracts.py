...
class RecoveryStatus(str, Enum):
    ...
    BELIEFS_COLLECTED = "BELIEFS_COLLECTED"
    BELIEFS_VALIDATED = "BELIEFS_VALIDATED"
    CONSENSUS_EVALUATED = "CONSENSUS_EVALUATED"
    POLICY_EVALUATED = "POLICY_EVALUATED"
    EXECUTING = "EXECUTING"
    OUTCOME_VERIFYING = "OUTCOME_VERIFYING"
    RECOVERED = "RECOVERED"
    FAILED = "FAILED"
    COMPLETED = "COMPLETED"
    BLOCKED = "BLOCKED"
...
class Recommendation(str, Enum):
    ...
    SETTLEMENT_ESCALATE = "SETTLEMENT_ESCALATE"
    RECOVER = "RECOVER"
...
class ConsensusResult:
    ...
    minimum_agent_count: int
    beliefs_received: int
    beliefs_used: int
    beliefs_rejected: int
    beliefs_quarantined: int
    conflicts_detected: bool
    support_by_action: dict[str, float]
...
class RecoveryState:
    ...
    agent_beliefs: list[dict[str, Any]] | None = None
    ...
    current_transaction_status: str | None = None
    current_failure_code: str | None = None
